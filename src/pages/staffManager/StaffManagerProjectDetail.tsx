        ...
        <div className="container mx-auto px-4 py-6">
            ...
            <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center gap-9">
                    <div className="p-3 rounded-lg flex items-center gap-3 cursor-pointer bg-rose-50 hover:bg-rose-100 text-rose-700 border-rose-200" onClick={handleDelete}>
                        <Trash2  size={18} />{isDeleting ? "Removing..." : "Remove from Favourites"}
                        </div>
                </div>
            </div>
