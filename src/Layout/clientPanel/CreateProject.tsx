...
const CreateProject = ({
  ...
  const allEmployees: IEmployeeProfile[] = employeesData?.data || [];
  ...
  const onSubmit = async (data: CreateProjectForm) => {
    try {
      const { dataUploadDateDays, status, workingDays, ...rest } = data;
      ...
      // cleanPayload will include 'workingDays' if it's not empty, which is what we want.
      // Assuming Backend accepts 'workingDays' or ignores it.
                        ...
                        {selectedStaffs.map((staffId, index) => {
                          ...
                          return (
                            <div
                              ...
                              title={`Click to remove ${staff?.user.name}`}
                            >
