        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent
                align="end"
                className="border-gray-100 bg-white cursor-pointer"
              >
                <DropdownMenuItem
                  className="cursor-pointer text-gray-600"
                  onClick={() => setSelectedPeriod("Last 24 Hours")}
                >
                  Last 24 Hours
                </DropdownMenuItem>
                <DropdownMenuItem
                  className="cursor-pointer text-gray-600"
                  onClick={() => setSelectedPeriod("Last 1 Week")}
                >
                  Last 1 Week
                </DropdownMenuItem>
                <DropdownMenuItem
                  className="cursor-pointer text-gray-600"
                  onClick={() => setSelectedPeriod("Last 1 Month")}
                >
                  Last 1 Month
                </DropdownMenuItem>
                <DropdownMenuItem
            ...
            {isSingleClientRoute ? (
              ...
              <Button
                className="gap-2 bg-blue-600 hover:bg-blue-700 text-gray-200 cursor-pointer transition-[300ms]"
