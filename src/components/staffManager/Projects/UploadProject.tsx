...
const UploadProject = () => {
  ...
  const [createSubmission, { isLoading: isSubmitting }] = useCreateEmployeeSubmissionMutation();
    ...
    try {
      ...
      reader.onload = async (e) => {
        ...
        workbook.SheetNames.forEach((sheetName) => {
          ...
          // Detect if first row is a header (all strings, non-numeric)
